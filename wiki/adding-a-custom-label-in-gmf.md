...
This has been implemented in [IAML](iaml.md) using [Dynamic Templates](dynamic-templates.md) in <a href="http://code.google.com/p/iaml/source/detail?r=650">revision 650</a>.

**If you want double clicks on the label** to open up a diagram ([GMF Diagram Partitioning](gmf-diagram-partitioning.md)), go into the .gmfgen and [add OpenDiagramEditPolicies](gmf-label-opendiagrameditpolicies.md) to each of the labels.
